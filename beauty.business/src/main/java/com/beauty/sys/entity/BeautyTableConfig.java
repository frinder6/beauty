...
public class BeautyTableConfig implements java.io.Serializable {
	...
	public BeautyTableConfig(String tableName, String title, String data, byte orderable, int width, String className, int sequence, String render, String remark, Date createTime, String creater, Date lastUpdateTime, String modifier, byte isDeleted, String def1, String def2, Date def3) {
