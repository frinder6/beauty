...
public class BeautyRole implements java.io.Serializable {
	...
	public BeautyRole(String code, String name, long groupId, String remark, Date createTime, String creater, Date lastUpdateTime, String modifier, byte isDeleted, String def1, String def2, Date def3) {
		this.code = code;
		this.name = name;
