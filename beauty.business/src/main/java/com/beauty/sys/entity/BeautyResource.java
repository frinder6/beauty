...
public class BeautyResource implements java.io.Serializable {
	...
	public BeautyResource(String code, String name, String url, long groupId, String remark, Date createTime, String creater, Date lastUpdateTime, String modifier, byte isDeleted, String def1, String def2, Date def3) {
		this.code = code;
		this.name = name;
		this.url = url;
