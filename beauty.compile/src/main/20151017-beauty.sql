...
-- ----------------------------
-- Table structure for beauty_conf_grid
-- ----------------------------
DROP TABLE IF EXISTS `beauty_conf_grid`;
CREATE TABLE `beauty_conf_grid` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `grid_name` varchar(100) NOT NULL DEFAULT '',
  `auto_width` tinyint(4) NOT NULL DEFAULT '1',
  `defer_render` tinyint(4) NOT NULL DEFAULT '1',
  `info` tinyint(4) NOT NULL DEFAULT '1',
  `j_query_ui` tinyint(4) NOT NULL DEFAULT '0',
  `length_change` tinyint(4) NOT NULL DEFAULT '1',
  `ordering` tinyint(4) NOT NULL DEFAULT '1',
  `paging` tinyint(4) NOT NULL DEFAULT '1',
  `processing` tinyint(4) NOT NULL DEFAULT '1',
  `scroll_x` tinyint(4) NOT NULL DEFAULT '1',
  `scroll_y` varchar(50) NOT NULL DEFAULT '',
  `searching` tinyint(4) NOT NULL DEFAULT '1',
  `server_side` tinyint(4) NOT NULL DEFAULT '1',
  `state_save` tinyint(4) NOT NULL DEFAULT '1',
  `defer_loading` tinyint(4) NOT NULL DEFAULT '0',
  `destory` tinyint(4) NOT NULL DEFAULT '0',
  `display_start` int(11) NOT NULL DEFAULT '0',
  `dom` varchar(100) NOT NULL DEFAULT '',
  `length_menu` varchar(200) NOT NULL DEFAULT '',
  `order_cells_top` tinyint(4) NOT NULL DEFAULT '0',
  `order_classes` tinyint(4) NOT NULL DEFAULT '1',
  `order` varchar(200) NOT NULL DEFAULT '',
  `order_multi` tinyint(4) NOT NULL DEFAULT '0',
  `order_fixed` varchar(100) NOT NULL DEFAULT '' COMMENT 'varchar',
  `page_length` int(11) NOT NULL DEFAULT '10',
  `scroll_collapse` tinyint(4) NOT NULL DEFAULT '0',
  `search_cols` varchar(100) NOT NULL DEFAULT '' COMMENT 'v',
  `search_delay` int(11) NOT NULL DEFAULT '0',
  `renderer` varchar(100) NOT NULL DEFAULT '',
  `retrieve` varchar(50) NOT NULL DEFAULT '',
  `state_duration` int(11) NOT NULL DEFAULT '0',
  `stripe_classes` varchar(50) NOT NULL DEFAULT '',
  ...
  `def3` datetime NOT NULL DEFAULT '1980-01-01 00:00:00',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_grid_name_uqe` (`grid_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of beauty_conf_grid
-- ----------------------------
INSERT INTO `beauty_conf_grid` VALUES ('1', 'default', '1', '1', '1', '0', '1', '1', '1', '1', '1', '500', '1', '1', '1', '0', '0', '0', '<\'row\'<\'.my-tool.col-xs-6\'><\'col-xs-6\'f>r>t<\'row\'<\'col-xs-3\'l><\'col-xs-3\'i><\'col-xs-6\'p>>', '', '0', '1', '[[2, \'asc\']]', '0', '[2, \'asc\']', '15', '0', '[]', '0', '', '', '0', '', '0', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
...
CREATE TABLE `beauty_resource` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_code_uqe` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=95 DEFAULT CHARSET=utf8 COMMENT='系统资源表';
...
INSERT INTO `beauty_resource` VALUES ('88', '19D1DA6CD1E52C215346A35C35D870E7', '', '/pages/Chinese.json', '0', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
...
CREATE TABLE `beauty_schema_columns` (
  ...
  `render` varchar(200) NOT NULL DEFAULT '',
  `orderable` tinyint(4) NOT NULL DEFAULT '1',
...
-- ----------------------------
INSERT INTO `beauty_schema_columns` VALUES ('1', '', '', 'id', 'id', '', '', '', '操作', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('2', '', '', 'code', 'code', '', '', '', '编码', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('3', '', '', 'name', 'name', '', '', '', '名称', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('4', '', '', 'groupId', 'group_id', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('5', '', '', 'type', 'type', '', '', '', '类型', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('6', '', '', 'remark', 'remark', '', '', '', '备注', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('7', '', '', 'createTime', 'create_time', '', '', '', '创建时间', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('8', '', '', 'creater', 'creater', '', '', '', '创建者', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('9', '', '', 'lastUpdateTime', 'last_update_time', '', '', '', '修改时间', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('10', '', '', 'modifier', 'modifier', '', '', '', '修改者', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('11', '', '', 'isDeleted', 'is_deleted', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('12', '', '', 'def1', 'def1', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('13', '', '', 'def2', 'def2', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('14', '', '', 'def3', 'def3', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('15', '', '', 'authorityId', 'authority_id', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('16', '', '', 'resourceId', 'resource_id', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('17', '', '', 'url', 'url', '', '', '', 'URL', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('18', '', '', 'parentId', 'parent_id', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('19', '', '', 'level', 'level', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('20', '', '', 'roleId', 'role_id', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('21', '', '', 'tableName', 'table_name', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('22', '', '', 'classPath', 'class_path', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('23', '', '', 'gridName', 'grid_name', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('24', '', '', 'columnId', 'column_id', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('25', '', '', 'title', 'title', '', '', '', '标题', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('26', '', '', 'data', 'data', '', '', '', '属性', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('27', '', '', 'columnName', 'column_name', '', '', '', '列名', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('28', '', '', 'orderable', 'orderable', '', '', '', '排序', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('29', '', '', 'width', 'width', '', '', '', '宽度', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('30', '', '', 'className', 'class_name', '', '', '', '样式', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('31', '', '', 'sequence', 'sequence', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('32', '', '', 'render', 'render', '', '', '', '渲染', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('33', '', '', 'account', 'account', '', '', '', '帐号', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('34', '', '', 'password', 'password', '', '', '', '密码', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('35', '', '', 'gender', 'gender', '', '', '', '性别', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('36', '', '', 'mobile', 'mobile', '', '', '', '手机', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('37', '', '', 'email', 'email', '', '', '', '邮箱', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('38', '', '', 'userId', 'user_id', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('39', '', '', 'qq', 'qq', '', '', '', 'QQ', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('40', '', '', 'wxNo', 'wx_no', '', '', '', '微信', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('41', '', '', 'address', 'address', '', '', '', '地址', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('42', '', '', 'favor', 'favor', '', '', '', '喜好', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('43', '', '', 'username', 'username', '', '', '', '用户名', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('44', '', '', 'series', 'series', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('45', '', '', 'token', 'token', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('46', '', '', 'lastUsed', 'last_used', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('64', '', '', 'cell_type', 'cell_type', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('65', '', '', 'default_content', 'default_content', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('66', '', '', 'searchable', 'searchable', '', '', '', '排序', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('67', '', '', 'visible', 'visible', '', '', '', '可用', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_schema_columns` VALUES ('68', '', '', 'targets', 'targets', '', '', '', '', '100', '', '1', '1', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=250 DEFAULT CHARSET=utf8 COMMENT='配置表头与列对应关系表';

-- ----------------------------
-- Records of beauty_table_columns
-- ----------------------------
INSERT INTO `beauty_table_columns` VALUES ('1', 'BEAUTY_MENU', '', '', 'name', 'name', '', '', '', '菜单名称', '100', null, '1', '1', '1', '', '1', '', '1980-01-01 00:00:00', 'admin', '2015-10-07 18:00:12', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('3', 'BEAUTY_MENU', '', '', 'code', 'code', '', '', '', '菜单编码', '300', null, '1', '1', '1', '', '2', '', '1980-01-01 00:00:00', 'admin', '2015-10-07 18:00:30', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('4', 'BEAUTY_MENU', '', '', 'remark', 'remark', '', '', '', '菜单备注', '150', null, '1', '1', '1', '', '3', '', '1980-01-01 00:00:00', 'admin', '2015-10-03 19:42:40', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('5', 'TABLES', '', '', 'tableName', 'table_name', '', '', '', '表名称', '300', null, '1', '1', '1', '', '1', '', '1980-01-01 00:00:00', 'admin', '2015-09-30 21:28:52', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('6', 'TABLES', '', '', 'tableComment', 'table_comment', '', '', '', '表描述', '780', null, '1', '1', '1', '', '2', '', '1980-01-01 00:00:00', 'admin', '2015-10-06 18:33:05', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('7', 'COLUMNS', '', '', 'columnName', 'column_name', '', '', '', '列名称', '450', null, '1', '1', '1', '', '2', '', '1980-01-01 00:00:00', 'admin', '2015-09-30 21:32:29', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('8', 'COLUMNS', '', 'hide', 'columnType', 'column_type', '', '', '', '列类型', '150', null, '1', '1', '1', '', '3', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('9', 'COLUMNS', '', 'hide', 'columnComment', 'column_comment', '', '', '', '列描述', '150', null, '1', '1', '1', '', '4', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('101', 'BEAUTY_TABLE_CONFIG', '', 'hide', 'id', 'id', '', '', '', '标识列', '50', null, '1', '1', '1', '', '0', 'id', '2015-08-15 19:43:27', 'admin', '2015-09-12 21:19:14', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('103', 'BEAUTY_TABLE_CONFIG', '', '', 'title', 'title', '', '', '', '列名', '150', null, '1', '1', '1', '', '2', 'title', '2015-08-15 19:43:27', 'admin', '2015-09-10 22:08:45', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('104', 'BEAUTY_TABLE_CONFIG', '', '', 'data', 'data', '', '', '', '类字段', '150', null, '1', '1', '1', '', '3', 'data', '2015-08-15 19:43:27', 'admin', '2015-09-10 22:10:39', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('105', 'BEAUTY_TABLE_CONFIG', '', '', 'columnName', 'column_name', '', '', '', '数据库字段', '150', null, '1', '1', '1', '', '4', 'column_name', '2015-08-15 19:43:27', 'admin', '2015-08-15 19:43:27', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('106', 'BEAUTY_TABLE_CONFIG', '', '', 'orderable', 'orderable', '', '', '', '排序', '150', null, '1', '1', '1', '', '5', 'orderable', '2015-08-15 19:43:28', 'admin', '2015-09-10 22:10:06', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('107', 'BEAUTY_TABLE_CONFIG', '', '', 'width', 'width', '', '', '', '宽', '150', null, '1', '1', '1', '', '6', 'width', '2015-08-15 19:43:28', 'admin', '2015-09-10 22:10:19', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('108', 'BEAUTY_TABLE_CONFIG', '', '', 'className', 'class_name', '', '', '', '样式', '150', null, '1', '1', '1', '', '7', 'class_name', '2015-08-15 19:43:28', 'admin', '2015-09-10 22:10:22', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('109', 'BEAUTY_TABLE_CONFIG', '', '', 'sequence', 'sequence', '', '', '', '序号', '150', null, '1', '1', '1', '', '8', 'sequence', '2015-08-15 19:43:28', 'admin', '2015-09-10 22:10:26', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('120', 'BEAUTY_TABLE_CONFIG', '', '', 'tableName', 'table_name', '', '', '', '表名', '200', null, '1', '1', '1', '', '1', 'table_name', '2015-08-15 20:18:03', 'admin', '2015-09-15 21:09:44', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('124', 'BEAUTY_TABLE_CONFIGED', '', '', 'columnName', 'column_name', '', '', '', '列名称', '450', null, '1', '1', '1', '', '1', '', '1980-01-01 00:00:00', 'admin', '2015-09-30 21:32:48', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('126', 'BEAUTY_TABLE_CONFIGED', '', 'hide', 'id', 'id', '', '', '', '标识列', '50', null, '1', '1', '1', '', '0', 'id', '2015-08-15 19:43:27', 'admin', '2015-09-12 21:19:29', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('132', 'BEAUTY_USER', '', '', 'name', 'name', '', '', '', '用户名', '150', null, '1', '1', '1', '', '1', 'name', '2015-08-23 21:33:02', 'admin', '2015-10-04 00:06:35', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('133', 'BEAUTY_USER', '', 'table-action', 'id', 'id', '', '', '', '操作', '50', null, '0', '1', '1', '', '0', 'id', '2015-08-23 21:33:02', 'admin', '2015-10-05 00:24:09', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('134', 'BEAUTY_USER', '', '', 'gender', 'gender', '', '', '', '性别', '50', null, '1', '1', '1', '', '4', 'gender', '2015-08-23 21:33:20', 'admin', '2015-10-04 00:08:07', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('135', 'BEAUTY_USER', '', '', 'account', 'account', '', '', '', '帐号', '150', null, '1', '1', '1', '', '2', 'account', '2015-08-23 21:33:24', 'admin', '2015-10-04 00:06:39', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('152', 'BEAUTY_MENU', '', '', 'url', 'url', '', '', '', '菜单路径', '380', null, '1', '1', '1', '', '4', 'url', '2015-08-30 16:23:33', 'admin', '2015-10-07 18:00:49', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('156', 'BEAUTY_URL', '', '', 'url', 'url', '', '', '', 'URL', '1180', null, '1', '1', '1', '', '0', 'url', '2015-09-07 21:08:13', 'admin', '2015-10-06 14:06:18', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('157', 'BEAUTY_URL', '', 'hide', 'remark', 'remark', '', '', '', '备注', '300', null, '2', '1', '1', '', '1', 'remark', '2015-09-07 21:08:13', 'admin', '2015-09-12 21:19:34', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('158', 'BEAUTY_URL', '', 'hide', 'id', 'id', '', '', '', '标识列', '50', null, '0', '1', '1', '', '2', 'id', '2015-09-07 21:08:13', 'admin', '2015-09-12 21:19:46', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('159', 'BEAUTY_RESOURCE', '', '', 'url', 'url', '', '', '', 'BEAUTY_RESOURCE', '380', null, '1', '1', '1', '', '2', 'url', '2015-09-07 22:36:07', 'admin', '2015-10-05 17:46:37', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('160', 'BEAUTY_RESOURCE', '', '', 'remark', 'remark', '', '', '', '备注', '300', null, '1', '1', '1', '', '3', 'remark', '2015-09-07 22:36:07', 'admin', '2015-10-05 17:46:14', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('161', 'BEAUTY_RESOURCE', '', 'hide', 'name', 'name', '', '', '', '资源名称', '150', null, '1', '1', '1', '', '5', 'name', '2015-09-07 22:36:07', 'admin', '2015-10-05 17:46:06', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('162', 'BEAUTY_RESOURCE', '', 'table-action', 'id', 'id', '', '', '', '操作', '50', null, '0', '1', '1', '', '0', 'id', '2015-09-07 22:36:09', 'admin', '2015-10-05 16:43:32', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('163', 'BEAUTY_RESOURCE', '', '', 'code', 'code', '', '', '', '资源编码', '300', null, '1', '1', '1', '', '1', 'code', '2015-09-07 22:36:17', 'admin', '2015-10-05 17:45:53', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('173', 'BEAUTY_AUTHORITY', '', 'table-action', 'type', 'type', '', '', '', '类型', '80', null, '1', '1', '1', '', '3', 'type', '2015-09-12 20:19:30', 'admin', '2015-10-05 22:05:41', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('174', 'BEAUTY_AUTHORITY', '', '', 'remark', 'remark', '', '', '', '备注', '350', null, '1', '1', '1', '', '4', 'remark', '2015-09-12 20:19:30', 'admin', '2015-10-05 22:05:10', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('175', 'BEAUTY_AUTHORITY', '', '', 'name', 'name', '', '', '', '权限名称', '150', null, '1', '1', '1', '', '1', 'name', '2015-09-12 20:19:31', 'admin', '2015-10-05 22:04:43', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('176', 'BEAUTY_AUTHORITY', '', 'table-action', 'id', 'id', '', '', '', '操作', '50', null, '0', '1', '1', '', '0', 'id', '2015-09-12 20:19:31', 'admin', '2015-10-05 01:58:07', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('177', 'BEAUTY_AUTHORITY', '', '', 'code', 'code', '', '', '', '权限编码', '350', null, '1', '1', '1', '', '2', 'code', '2015-09-12 20:22:13', 'admin', '2015-10-05 22:04:54', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('182', 'BEAUTY_A_R', '', 'hide', 'code', 'code', '', '', '', '资源编码', '50', null, '1', '1', '1', '', '4', 'url', '2015-09-07 22:36:07', 'admin', '2015-09-18 20:08:38', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('183', 'BEAUTY_A_R', '', '', 'url', 'url', '', '', '', '资源URL', '400', null, '1', '1', '1', '', '1', 'name', '2015-09-07 22:36:07', 'admin', '2015-10-03 01:29:48', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('184', 'BEAUTY_A_R', '', 'hide', 'resourceId', 'resource_id', '', '', '', '标识列', '50', null, '1', '1', '1', '', '0', 'id', '2015-09-07 22:36:09', 'admin', '2015-09-17 22:11:18', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('185', 'BEAUTY_A_R_CONFIGED', '', 'hide', 'code', 'code', '', '', '', '资源编码', '50', null, '1', '1', '1', '', '4', 'url', '2015-09-07 22:36:07', 'admin', '2015-09-17 22:48:22', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('186', 'BEAUTY_A_R_CONFIGED', '', '', 'url', 'url', '', '', '', '资源URL', '400', null, '1', '1', '1', '', '1', 'name', '2015-09-07 22:36:07', 'admin', '2015-10-03 01:30:09', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('187', 'BEAUTY_A_R_CONFIGED', '', 'hide', 'id', 'id', '', '', '', '标识列', '50', null, '1', '1', '1', '', '0', 'id', '2015-09-07 22:36:09', 'admin', '2015-09-16 22:09:21', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('188', 'BEAUTY_ROLE', '', '', 'name', 'name', '', '', '', '角色名称', '200', null, '1', '1', '1', '', '1', '', '1980-01-01 00:00:00', 'admin', '2015-10-03 23:03:01', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('189', 'BEAUTY_ROLE', '', '', 'code', 'code', '', '', '', '角色编码', '300', null, '1', '1', '1', '', '2', '', '1980-01-01 00:00:00', 'admin', '2015-10-03 23:03:52', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('190', 'BEAUTY_ROLE', '', 'table-action', 'id', 'id', '', '', '', '操作', '50', null, '0', '1', '1', '', '0', '', '1980-01-01 00:00:00', 'admin', '2015-10-05 02:00:59', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('215', 'BEAUTY_R_A', '', '', 'code', 'code', '', '', '', '权限编码', '150', null, '1', '1', '1', '', '4', 'url', '2015-09-07 22:36:07', 'admin', '2015-10-03 01:50:20', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('216', 'BEAUTY_R_A', '', 'hide', 'id', 'id', '', '', '', '标识列', '50', null, '1', '1', '1', '', '0', 'id', '2015-09-07 22:36:09', 'admin', '2015-10-03 01:47:30', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('218', 'BEAUTY_R_A_CONFIGED', '', '', 'code', 'code', '', '', '', '权限编码', '150', null, '1', '1', '1', '', '4', 'url', '2015-09-07 22:36:07', 'admin', '2015-10-03 01:50:31', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('219', 'BEAUTY_R_A_CONFIGED', '', 'hide', 'authorityId', 'authority_id', '', '', '', '标识列', '50', null, '1', '1', '1', '', '0', 'id', '2015-09-07 22:36:09', 'admin', '2015-10-03 01:47:09', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('221', 'BEAUTY_R_A', '', '', 'name', 'name', '', '', '', '权限名称', '200', null, '1', '1', '1', '', '4', 'url', '2015-09-07 22:36:07', 'admin', '2015-10-03 01:50:26', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('222', 'BEAUTY_R_A_CONFIGED', '', '', 'name', 'name', '', '', '', '权限名称', '200', null, '1', '1', '1', '', '4', 'url', '2015-09-07 22:36:07', 'admin', '2015-10-03 01:50:37', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('223', 'BEAUTY_A_R_M', '', '', 'code', 'code', '', '', '', '菜单编码', '250', null, '1', '1', '1', '', '4', 'url', '2015-09-07 22:36:07', 'admin', '2015-10-03 12:45:19', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('224', 'BEAUTY_A_R_M', '', '', 'name', 'name', '', '', '', '菜单名称', '200', null, '1', '1', '1', '', '1', 'name', '2015-09-07 22:36:07', 'admin', '2015-10-03 12:45:06', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('225', 'BEAUTY_A_R_M', '', 'hide', 'resourceId', 'resource_id', '', '', '', '标识列', '50', null, '1', '1', '1', '', '0', 'id', '2015-09-07 22:36:09', 'admin', '2015-10-03 12:45:09', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('226', 'BEAUTY_A_R_M_CONFIGED', '', '', 'code', 'code', '', '', '', '菜单编码', '250', null, '1', '1', '1', '', '4', 'url', '2015-09-07 22:36:07', 'admin', '2015-10-03 12:45:16', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('227', 'BEAUTY_A_R_M_CONFIGED', '', '', 'name', 'name', '', '', '', '菜单名称', '200', null, '1', '1', '1', '', '1', 'name', '2015-09-07 22:36:07', 'admin', '2015-10-03 12:44:12', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('228', 'BEAUTY_A_R_M_CONFIGED', '', 'hide', 'id', 'id', '', '', '', '标识列', '50', null, '1', '1', '1', '', '0', 'id', '2015-09-07 22:36:09', 'admin', '2015-10-03 12:44:15', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('230', 'BEAUTY_MENU_DIALOG', '', '', 'name', 'name', '', '', '', '菜单名称', '200', null, '1', '1', '1', '', '1', '', '1980-01-01 00:00:00', 'admin', '2015-10-03 17:56:58', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('231', 'BEAUTY_MENU_DIALOG', '', '', 'code', 'code', '', '', '', '菜单编码', '200', null, '1', '1', '1', '', '2', '', '1980-01-01 00:00:00', 'admin', '2015-10-03 17:57:01', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('234', 'BEAUTY_ROLE', '', '', 'remark', 'remark', '', '', '', '备注', '300', null, '1', '1', '1', '', '3', '', '1980-01-01 00:00:00', 'admin', '2015-10-03 23:03:58', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('235', 'BEAUTY_USER', '', '', 'remark', 'remark', '', '', '', '备注', '200', null, '1', '1', '1', '', '7', '', '1980-01-01 00:00:00', 'admin', '2015-10-04 00:08:14', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('236', 'BEAUTY_USER', '', '', 'password', 'password', '', '', '', '密码', '150', null, '1', '1', '1', '', '3', '', '1980-01-01 00:00:00', 'admin', '2015-10-04 00:06:42', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('237', 'BEAUTY_USER', '', '', 'mobile', 'mobile', '', '', '', '手机', '150', null, '1', '1', '1', '', '5', '', '1980-01-01 00:00:00', 'admin', '2015-10-04 00:07:14', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('238', 'BEAUTY_USER', '', '', 'email', 'email', '', '', '', '邮箱', '150', null, '1', '1', '1', '', '6', '', '1980-01-01 00:00:00', 'admin', '2015-10-04 00:07:17', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('239', 'BEAUTY_U_R', '', 'hide', 'id', 'id', '', '', '', '标识列', '50', null, '1', '1', '1', '', '0', 'id', '2015-09-07 22:36:09', 'admin', '2015-10-04 23:06:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('240', 'BEAUTY_U_R_CONFIGED', '', 'hide', 'roleId', 'role_id', '', '', '', '标识列', '50', null, '1', '1', '1', '', '0', 'id', '2015-09-07 22:36:09', 'admin', '2015-10-04 23:07:06', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('241', 'BEAUTY_U_R', '', '', 'name', 'name', '', '', '', '角色名称', '200', null, '1', '1', '1', '', '4', 'url', '2015-09-07 22:36:07', 'admin', '2015-10-04 23:06:20', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('242', 'BEAUTY_U_R_CONFIGED', '', '', 'name', 'name', '', '', '', '角色名称', '200', null, '1', '1', '1', '', '4', 'url', '2015-09-07 22:36:07', 'admin', '2015-10-04 23:06:43', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('248', 'BEAUTY_MENU', '', 'table-action', 'id', 'id', '', '', '', '操作', '50', null, '0', '1', '1', '', '0', '', '1980-01-01 00:00:00', 'admin', '2015-10-05 16:46:30', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns` VALUES ('249', 'TABLES', '', 'table-action', 'tableSchema', 'table_schema', '', '', '', '操作', '50', null, '0', '1', '1', '', '0', '', '1980-01-01 00:00:00', 'admin', '2015-10-06 18:33:47', 'admin', '1', '', '', '1980-01-01 00:00:00');

-- ----------------------------
-- Table structure for beauty_table_columns_
-- ----------------------------
DROP TABLE IF EXISTS `beauty_table_columns_`;
CREATE TABLE `beauty_table_columns_` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'bigint',
  `grid_name` varchar(200) NOT NULL DEFAULT '' COMMENT 'var',
  `column_id` bigint(20) NOT NULL COMMENT 'big',
  `cell_type` varchar(50) NOT NULL DEFAULT '',
  `class_name` varchar(50) NOT NULL DEFAULT '',
  `data` varchar(50) NOT NULL DEFAULT '',
  `column_name` varchar(50) NOT NULL DEFAULT '',
  ...
  `def3` datetime NOT NULL DEFAULT '1980-01-01 00:00:00',
  PRIMARY KEY (`id`),
  KEY `idx_grid_name` (`grid_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of beauty_table_columns_
-- ----------------------------
INSERT INTO `beauty_table_columns_` VALUES ('1', 'beauty_conf_columns', '1', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '0', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('2', 'beauty_conf_columns', '25', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('3', 'beauty_conf_columns', '26', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '2', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('4', 'beauty_conf_columns', '30', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '4', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('5', 'beauty_conf_columns', '27', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '3', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('6', 'beauty_conf_columns', '28', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '6', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('7', 'beauty_conf_columns', '29', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '5', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('8', 'beauty_conf_columns', '32', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '9', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('9', 'beauty_conf_columns', '66', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '7', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('10', 'beauty_conf_columns', '67', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '8', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('11', 'columns_relation', '1', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '1', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('12', 'columns_relation', '25', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '2', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_table_columns_` VALUES ('13', 'columns_relation', '27', '', '', '', '', '', '', '', '', '100', '', '1', '1', '1', '', '3', '', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
...
INSERT INTO `beauty_url` VALUES ('97', '/pages/bracket/profile.html', '/pages/bracket/profile.html', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_url` VALUES ('98', '/grid/load/id.action', '/grid/load/id.action', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_url` VALUES ('99', '/pages/bracket/Chinese.json', '/pages/bracket/Chinese.json', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
INSERT INTO `beauty_url` VALUES ('100', '/pages/bracket/dwr.jsp', '/pages/bracket/dwr.jsp', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
...
INSERT INTO `beauty_url` VALUES ('102', '/errors/secondLogin.html', '/errors/secondLogin.html', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
...
INSERT INTO `beauty_url` VALUES ('104', '/grid/load/grid.action', '/grid/load/grid.action', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
...
INSERT INTO `beauty_url` VALUES ('109', '/crelation/load/page.action', '/crelation/load/page.action', '1980-01-01 00:00:00', 'admin', '1980-01-01 00:00:00', 'admin', '1', '', '', '1980-01-01 00:00:00');
...
-- ----------------------------
INSERT INTO `persistent_logins` VALUES ('admin', '/FtPPiKhjQVMmkeGXFxtzA==', '7kcBBPzPbb0lEbwimpfFHQ==', '2015-10-12 22:37:51');
INSERT INTO `persistent_logins` VALUES ('admin', '3TZhdw4z8PIWDcFo7maDvQ==', 'gIGvTNaN8Hhw+Cmg/lAoJQ==', '2015-10-17 23:22:28');
INSERT INTO `persistent_logins` VALUES ('admin', 'EijvGlx+RSsKAVhFvPdENw==', 'E6jl+TxHxW1j15ZuJyLt6w==', '2015-10-12 21:50:38');
INSERT INTO `persistent_logins` VALUES ('admin', 'gZ73G7H545Zlu2e4F/ilYg==', 'MeOsfwJ0oXsKnEwom+hHKQ==', '2015-10-18 00:36:27');
INSERT INTO `persistent_logins` VALUES ('admin', 'yzwcjdzRKGayQNGxyxTpCg==', 'XcXc2glZTHchPCT1yeoHYw==', '2015-10-14 00:39:48');
